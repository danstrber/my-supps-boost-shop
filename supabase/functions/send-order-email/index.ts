  ...
  try {
        ...
        <div style="padding: 30px;">
          ...
          <div style="background: #eff6ff; border: 1px solid #bfdbfe; border-radius: 8px; padding: 20px; margin-bottom: 25px;">
            ...
            ${orderData.paymentMethod === 'telegram' ? 
              ...
              '<p style="color: #374151; margin: 0;">Your payment has been processed successfully.</p>'
            }
          </div>
    ...
    const adminEmailHtml = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <h1 style="color: #dc2626; font-size: 24px;">🚨 NEW ORDER RECEIVED</h1>
    ...
    const customerEmailResponse = await resend.emails.send({
      ...
      subject: "Order Confirmation - MySupps",
    ...
    const adminEmailResponse = await resend.emails.send({
      ...
      subject: `NEW ORDER: ${orderData.customerName} - $${orderData.finalTotal.toFixed(2)}`,
      html: adminEmailHtml,
    });
