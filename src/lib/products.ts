...
export const products: Product[] = [
  {
    ...
    details: {
      ...
      sideEffects: 'Hepatotoxicity (liver stress), cardiovascular strain, blood pressure elevation, cholesterol imbalances, testosterone suppression, mood changes, potential hair loss, acne, joint pain, headaches, fatigue.',
  ...
  },
  {
    ...
    details: {
      ...
      sideEffects: 'Water retention, increased appetite, potential blood sugar fluctuations, temporary lethargy, tingling in hands/feet, possible increased prolactin levels, joint pain, vivid dreams.',
  ...
  },
  {
    ...
    details: {
      ...
      sideEffects: 'Testosterone suppression, mild aggression, possible hair loss in predisposed individuals, mood changes, potential liver stress, headaches, nausea, fatigue, joint pain, acne.',
  ...
  },
  {
    ...
    details: {
      ...
      sideEffects: 'Jitters and tremors, increased heart rate, excessive sweating, insomnia, muscle cramps, potential cardiac stress, anxiety, headaches, increased blood pressure, dehydration.',
  ...
  },
  {
    ...
    details: {
      ...
      sideEffects: 'Mild mood swings, potential vision changes (rare), hot flashes, temporary libido fluctuations, headaches, nausea, fatigue during adjustment, possible mild depression.',
  ...
  },
  {
    ...
    details: {
      ...
      sideEffects: 'Joint pain and stiffness, reduced bone density with long-term use, mood changes, dry skin and hair, possible negative impact on cholesterol, fatigue, headaches, hot flashes.',
