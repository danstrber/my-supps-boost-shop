...
export const products: Product[] = [
  {
    ...
    details: {
      ...
      sideEffects: 'Severe hepatotoxicity (liver stress/damage), cardiovascular strain, significant blood pressure elevation, cholesterol imbalances, complete natural testosterone suppression, mood changes, aggression, potential hair loss, acne, joint pain, headaches, fatigue, sleep disturbances, potential kidney stress, increased risk of blood clots.',
  ...
  },
  {
    ...
    details: {
      ...
      sideEffects: 'Water retention, significantly increased appetite, potential blood sugar fluctuations, temporary lethargy in some users, tingling in hands/feet initially, possible increased prolactin levels, joint pain in some users, potential insulin resistance with long-term use, vivid dreams, occasional headaches.',
  ...
  },
  {
    ...
    details: {
      ...
      sideEffects: 'Significant testosterone suppression (often complete), mild to moderate aggression in some users, possible hair loss in predisposed individuals, mood changes, potential liver stress, headaches, nausea, fatigue during suppression phase, possible increase in blood pressure, joint pain, acne breakouts.',
  ...
  },
  {
    ...
    details: {
      ...
      sideEffects: 'Jitters and tremors, increased heart rate and palpitations, excessive sweating, insomnia and sleep disturbances, muscle cramps (especially legs), potential cardiac stress at high doses, anxiety and restlessness, headaches, increased blood pressure, dehydration, electrolyte imbalances, potential tolerance buildup, nausea.',
  ...
  },
  {
    ...
    details: {
      ...
      sideEffects: 'Mild mood swings and emotional fluctuations, potential vision changes (rare but serious), hot flashes, temporary libido fluctuations during hormone restoration, headaches, nausea, fatigue during initial adjustment period, possible mild depression, sleep disturbances.',
  ...
  },
  {
    ...
    details: {
      ...
      sideEffects: 'Joint pain and stiffness, reduced bone density with long-term use, potential mood changes and depression, dry skin and hair, possible negative impact on cholesterol, fatigue, headaches, hot flashes, decreased libido if estrogen crashes too low, potential cognitive effects, sleep disturbances.',
