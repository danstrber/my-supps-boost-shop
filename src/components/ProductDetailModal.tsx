          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4 text-sm">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                ...
                <p className="text-blue-700 text-xs leading-relaxed">{product.details.research}</p>
              </div>
              ...
              <div className="bg-green-50 border border-green-200 rounded-lg p-3">
                ...
                <p className="text-green-700 text-xs leading-relaxed">{product.details.benefits}</p>
              </div>
              ...
              <div className="bg-red-50 border border-red-200 rounded-lg p-3">
                ...
                <p className="text-red-700 text-xs leading-relaxed">{product.details.sideEffects}</p>
              </div>

              {/* Effects on Women */}
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
                <h4 className="font-semibold text-yellow-800 mb-2">{l.effectsOnWomen}</h4>
                <p className="text-yellow-700 text-xs leading-relaxed">{product.details.effectsOnWomen}</p>
              </div>

              {/* How It Works */}
              <div className="bg-purple-50 border border-purple-200 rounded-lg p-3">
                <h4 className="font-semibold text-purple-800 mb-2">{l.howItWorks}</h4>
                <p className="text-purple-700 text-xs leading-relaxed">{product.details.howItWorks}</p>
              </div>

              {/* Safety */}
              <div className="bg-orange-50 border border-orange-200 rounded-lg p-3">
                <h4 className="font-semibold text-orange-800 mb-2">{l.safety}</h4>
                <p className="text-orange-700 text-xs leading-relaxed">{product.details.safety}</p>
              </div>

              {/* Cycle Information */}
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-3">
                <h4 className="font-semibold text-gray-800 mb-2">{l.cycle}</h4>
                <p className="text-gray-700 text-xs leading-relaxed mb-2">{product.details.cycle}</p>
                <div className="bg-white p-2 rounded border">
                  <h5 className="font-semibold text-gray-800 mb-1 text-xs">{l.expectations}</h5>
                  <p className="text-gray-700 text-xs">{product.details.expectations}</p>
                </div>
              </div>
